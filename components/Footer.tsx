...
export const Footer = ({
  companyName = "Vistar",
  tagline = "Vistar Innovations Pvt. Ltd. is an early-stage EdTech initiative based in Hyderabad, India. We are grounded in reality, not hype. Incubated at ACIC-CBIT Hyderabad.",
  sections = defaultSections,
  socialLinks = {
    twitter: "https://twitter.com",
    linkedin: "https://linkedin.com",
    github: "https://github.com",
    email: "hello@vistar.in",
  },
  copyrightText,
}: FooterProps) => {
  const currentYear = new Date().getFullYear()
  const copyright = copyrightText || `© ${currentYear} Vistar Innovations Pvt. Ltd. All rights reserved.`
  return (
